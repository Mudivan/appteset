...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Series.count") do
      post series_index_url, params: { series: { nome: @series.nome, plataforma: @series.plataforma, situacao: @series.situacao, temporada: @series.temporada } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { nome: @series.nome, plataforma: @series.plataforma, situacao: @series.situacao, temporada: @series.temporada } }
